...
%     \vspace*{-2mm}\\
%     \begin{figure}[H]
%         \includegraphics[width=0.45\textwidth]{bessel.png}
%     \end{figure}
% \vspace*{0mm}
%
% \vspace*{4mm}
...
%     \qquad Caractérisation spatiale et spectrale de l'émission
%         \begin{figure}[c]\centering
%             \includegraphics[width=0.20\textwidth]{{"bessel_profil"}.png}
%             \;
%             \includegraphics[width=0.47\textwidth]{{"bessel_courbe"}.png}
